...
def process_time_range(file_, time_start = "09:30:00", time_end = "16:00:00"):
    ...
    # Interpolate sparse missing prices
    # Example series with zeros
    series = np.array(price_list)
    # Find indices of zeros
    zero_indices = np.where(series == 0)[0]
    ...
    series[zero_indices] = interpolated_values
